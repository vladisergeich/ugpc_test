<template>
    <div class="main_operation_wrapper">   
        <div class="shaft_info_row" v-if="this.selectedMainOperation != null">
            <div class="shaft_info_engraving_block">
                <span class="block_title">№ гравировальной головки:</span>
                <a-input class="block_engraving_value" v-model="selectConsumpShaft.engraving_head_number" />
            </div>
            <div class="shaft_info_engraving_block">
                <span class="block_title">№ резца:</span>
                <a-input class="block_engraving_value" v-model="selectConsumpShaft.engraving_cutter_number"/>
            </div>
        </div>
        <div class="shaft_info_row_btn">
            ...
            <a-button class="operation_engraving_btn" style="margin-right: 10px;" v-if="this.selectedMainOperation == null" @click="startOperation(selectMainOperation)">Гравировать</a-button>
            ...
            <a-button v-if="this.selectedMainOperation == null" class="operation_engraving_btn" @click="deleteConsumpShaft(selectConsumpShaft)">Отменить</a-button>
        </div>
    </div>
</template>
