        ...
        <div class="tabs_row">
            <a-tabs>
                <a-tab-pane key="1" tab="Свод">
                    ...
                    <a-select default-value="Выберите смену" style="display: block; width: 250px;" v-model="selectWorkShift" @change="getWorkShiftCode()">
                        ...
                        <div class="electroplating_card">
                            ...
                            <div class="electroplating_baths_row">
                                ...
                                <div class="electroplating_baths_card" @click="showMachineTable('Dec')">
                                    ...
                                    <div class="electroplating_working_free_row" v-if="machines['Dec'].workingShaft == ''">
                                        <span class="electroplating_working_free_desc">Свободен</span>
                                    </div>
                                    <div class="electroplating_made_shaft_row" v-if="machines['Dec'].workingShaft != ''">
                                        <span class="electroplating_shaft_work">{{machines['Dec'].workingShaft}}</span>
                                        <span class="electroplating_shaft_desc">вал в работе</span>
                                    </div>
                                </div>
                ...
                columns_daily_plan: [
                    ...
                    customRender: (value, row, index) => {
                        ...
                        if (!row.group_row) {
                            ...
                            return {
                                children: <div><span style="margin-right: 20px;">Оквид: {row.okvid_number}</span> <span> Дата готовности: {row.completion_date}</span></div>,
                                attrs: {
                                colSpan: 16,
                                },
                            };
                    ...
                    customRender: (value, row, index) => {
                        if (!row.group_row) {
                            if (row.dechromization && row.dechromization_defect) {
                                return {
                                    children: <div class="" style="text-align: center; width: 100%;">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="17" height="16" viewBox="0 0 17 16" fill="none">
                                                    <rect x="1.17871" y="0.5" width="15" height="15" rx="3.5" fill="#fa0f02"/>
                                                    <rect x="1.17871" y="0.5" width="15" height="15" rx="3.5" stroke="#9A9A9A"/>
                                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M13.8859 4.70711C14.2764 5.09763 14.2764 5.7308 13.8859 6.12132L8.09302 11.9142C7.70249 12.3047 7.06933 12.3047 6.6788 11.9142L3.38591 8.62132C2.99539 8.2308 2.99539 7.59763 3.38591 7.20711C3.77644 6.81658 4.4096 6.81658 4.80012 7.20711L7.38591 9.79289L12.4717 4.70711C12.8622 4.31658 13.4954 4.31658 13.8859 4.70711Z" fill="white"/>
                                                </svg>
                                            </div>,
                    ...
                    customRender: (value, row, index) => {
                        if (!row.group_row) {
                            if (row.base_grinding && row.base_grinding_defect) {
                                return {
                                    children: <div class="" style="text-align: center; width: 100%;">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="17" height="16" viewBox="0 0 17 16" fill="none">
                                                    <rect x="1.17871" y="0.5" width="15" height="15" rx="3.5" fill="#fa0f02"/>
                    ...
                    customRender: (value, row, index) => {
                        if (!row.group_row) {
                            if (row.steel_degreasing && row.steel_degreasing_defect) {
                                return {
                                    children: <div class="" style="text-align: center; width: 100%;">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="17" height="16" viewBox="0 0 17 16" fill="none">
                                                    <rect x="1.17871" y="0.5" width="15" height="15" rx="3.5" fill="#fa0f02"/>
                    ...
                    customRender: (value, row, index) => {
                        if (!row.group_row) {
                            if (row.pre_copper_plating && row.pre_copper_plating_defect) {
                                return {
                                    children: <div class="" style="text-align: center; width: 100%;">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="17" height="16" viewBox="0 0 17 16" fill="none">
                                                    <rect x="1.17871" y="0.5" width="15" height="15" rx="3.5" fill="#fa0f02"/>
                    ...
                    customRender: (value, row, index) => {
                        if (!row.group_row) {
                            if (row.base_copper_plating && row.base_copper_plating_defect) {
                                return {
                                    children: <div class="" style="text-align: center; width: 100%;">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="17" height="16" viewBox="0 0 17 16" fill="none">
                                                    <rect x="1.17871" y="0.5" width="15" height="15" rx="3.5" fill="#fa0f02"/>
                    ...
                    customRender: (value, row, index) => {
                        if (!row.group_row) {
                            if (row.base_degreasing && row.base_degreasing_defect) {
                                return {
                                    children: <div class="" style="text-align: center; width: 100%;">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="17" height="16" viewBox="0 0 17 16" fill="none">
                                                    <rect x="1.17871" y="0.5" width="15" height="15" rx="3.5" fill="#fa0f02"/>
                    ...
                    customRender: (value, row, index) => {
                        if (!row.group_row) {
                            if (row.copper_plating_edition && row.copper_plating_edition_defect) {
                                return {
                                    children: <div class="" style="text-align: center; width: 100%;">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="17" height="16" viewBox="0 0 17 16" fill="none">
                                                    <rect x="1.17871" y="0.5" width="15" height="15" rx="3.5" fill="#fa0f02"/>
                    ...
                    customRender: (value, row, index) => {
                        if (!row.group_row) {
                            if (row.grinding_edition && row.grinding_edition_defect) {
                                return {
                                    children: <div class="" style="text-align: center; width: 100%;">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="17" height="16" viewBox="0 0 17 16" fill="none">
                                                    <rect x="1.17871" y="0.5" width="15" height="15" rx="3.5" fill="#fa0f02"/>
                    ...
                    customRender: (value, row, index) => {
                        if (!row.group_row) {
                            if (row.engraving && row.engraving_defect) {
                                return {
                                    children: 
                                                    <a-popover placement="topLeft" arrow-point-at-center>
                                                        <template slot="content">
                                                            <h6>{row.defect_note}</h6>
                                                        </template>
                    ...
                    customRender: (value, row, index) => {
                        if (!row.group_row) {
                            if (row.degreasing_edition && row.degreasing_edition_defect) {
                                return {
                                    children: <div class="" style="text-align: center; width: 100%;">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="17" height="16" viewBox="0 0 17 16" fill="none">
                                                    <rect x="1.17871" y="0.5" width="15" height="15" rx="3.5" fill="#fa0f02"/>
                    ...
                    customRender: (value, row, index) => {
                        if (!row.group_row) {
                            if (row.chrome_plating && row.chrome_plating_defect) {
                                return {
                                    children: <div class="" style="text-align: center; width: 100%;">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="17" height="16" viewBox="0 0 17 16" fill="none">
                                                    <rect x="1.17871" y="0.5" width="15" height="15" rx="3.5" fill="#fa0f02"/>
                    ...
                    customRender: (value, row, index) => {
                        if (!row.group_row) {
                            if (row.polishing_chrome && row.polishing_chrome_defect) {
                                return {
                                    children: <div class="" style="text-align: center; width: 100%;">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="17" height="16" viewBox="0 0 17 16" fill="none">
                                                    <rect x="1.17871" y="0.5" width="15" height="15" rx="3.5" fill="#fa0f02"/>
                    ...
                    customRender: (value, row, index) => {
                        if (!row.group_row) {
                            if (row.test_print && row.test_print_defect) {
                                return {
                                    children: <div class="" style="text-align: center; width: 100%;">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="17" height="16" viewBox="0 0 17 16" fill="none">
                                                    <rect x="1.17871" y="0.5" width="15" height="15" rx="3.5" fill="#fa0f02"/>
        ...
        methods: {
            ...
            shaftMadeInputControl() {  
                ...
                dailyPlanOperations.forEach(item => {
                    if ((item.machine in this.machines) && (item.description != 'Забраковка вала')) {
                        ...
                        this.machines['Brak'].operations.push(item);     
                    }
                });
            },

            getWorkShiftCode() {
                axios.post(this.urlgetworkshiftcode,{code: this.selectWorkShift})
                .then(response => {
