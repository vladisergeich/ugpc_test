                ...
                <tr>
                    <td style="width: 80px; text-align: left; align-items: top; vertical-align:top;">
                        ...
                        <div class=""
                            ...
                            <div style="display: block;">
                                ...
                                <span>{{ date('d.m.Y', strtotime($transfer->shipping_date)) }}</span>
                            </div>
                            <div style="display: block;">
                        ...
                        <div class=""
                            ...
                            <div style="display: block;">
                                ...
                                <span>{{ $transfer->sender->contacts->address ?? ''}}</span>
                            </div>
                            <div style="display: block;">
                                <label style="font-weight: bold;"> тел/факс:</label>
                                <span>{{ $transfer->sender->contacts->phone_fax ?? ''}}</span>
                            </div>
                        </div>
                        <div class=""
                            style="border: 1px solid black; align-items: top; padding: 10px; margin-top: 20px; width: 90%">
                            <div style="display: block;">
                                ...
                                <span>{{ $transfer->sender->contacts->contact ?? ''}}</span>
                            </div>
                            <div style="display: block;">
                                <label style="font-weight: bold;"> Должность:</label>
                                <span>{{ $transfer->sender->contacts->contact_position ?? ''}}</span>
                            </div>
                            <div style="display: block;">
                                <label style="font-weight: bold;"> тел:</label>
                                <span>{{ $transfer->sender->contacts->contact_phone ?? ''}}</span>
                                <span>{{ $transfer->sender->contacts->contact_two ?? ''}}</span>
                            </div>
                        </div>
                    <td style="width: 480px; text-align: left; vertical-align:top;">
                        ...
                        <div class="" style="display: inline-block; margin-left: 30px; align-items: top;">
                            <label style="font-weight: bold;">от {{ date('d.m.Y', strtotime($transfer->create_date)) }}</label>
                        </div>
                        <div class=""
                            style="border: 1px solid black; align-items: top; padding: 10px; margin-top: 20px; width: 90%">
                            <div style="display: block;">
                                <label style="font-weight: bold;"> Адрес получателя:</label>
                                <span>{{ $transfer->recipient->contacts->address ?? ''}}</span>
                            </div>
                            <div style="display: block;">
                                <label style="font-weight: bold;"> тел/факс:</label>
                                <span>{{ $transfer->recipient->contacts->phone_fax ?? ''}}</span>
                            </div>
                        </div>
                        <div class=""
                            style="border: 1px solid black; align-items: top; padding: 10px; margin-top: 20px; width: 90%">
                            <div style="display: block;">
                                ...
                                <span>{{ $transfer->recipient->contacts->contact ?? ''}}</span>
                            </div>
                            <div style="display: block;">
                                <label style="font-weight: bold;"> Контакт:</label>
                                <span>{{ $transfer->recipient->contacts->contact_position ?? ''}}</span>
                            </div>
                            <div style="display: block;">
                                <label style="font-weight: bold;"> тел:</label>
                                <span>{{ $transfer->recipient->contacts->contact_phone ?? ''}}</span>
                            </div>
                        </div>
                        <div class=""
                            style="border: 1px solid black; align-items: top; padding: 10px; margin-top: 20px; width: 90%">
                        ...
                        <div class=""
                            ...
                            <div style="display: inline-block;">
                                ...
                                <span>{{ $transfer->shafts->count() ?? ''}}</span>
                            </div>
                            <div style="display: inline-block;">
                            ...
                            <div style="display: inline-block;">
                                ...
                                <span>{{ $transfer->shafts->count() * 160 }}</span>
                                <span>КГ</span>
                            </div>
                        </div>
                    </td>
                ...
                @foreach ($transfer->shafts as $shaft)
                    <tr>
                        <td style="border: 1px solid; height: 10px; padding: 5px;">
                            {{ $shaft->engravingOrder->okvid_number ?? ''}}
                        </td>
                        ...
                        <td style="border: 1px solid; height: 10px; padding: 5px; width: 60px;">
                            {{ $shaft->shaft->code ?? ''}}</td>
                        <td style="border: 1px solid; height: 10px; padding: 5px;">{{ $shaft->shaft->ff ?? ''}}</td>
                        <td style="border: 1px solid; height: 10px; padding: 5px;">
                            {{ $shaft->shaft->warehouse->name ?? ''}}</td>
                        <td style="border: 1px solid; height: 10px; padding: 5px;">{{ $shaft->type ?? ''}}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
